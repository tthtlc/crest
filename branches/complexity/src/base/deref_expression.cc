...
namespace crest {
	...
	size_t DerefExpr::DerefExpr::Size() { return 0; }

	void DerefExpr::AppendVars(set<var_t>* vars) { ; }

	bool DerefExpr::DependsOn(const map<var_t,type_t>& vars) { return false; }
	...
	bool DerefExpr::IsConcrete() {return false;}

	bool DerefExpr::operator==(DerefExpr &e) { return false; }
